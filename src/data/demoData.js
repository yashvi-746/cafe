...
export const PRODUCTS = [
  { id:"p1", name:"Ethiopian Pour Over", cat:"Coffee", price:260, veg:true, best:true, tags:["hot","light","fruity"], desc:"Single-origin Yirgacheffe, washed process, notes of jasmine and stone fruit.", cal:15, allergens:[], prep:5, rating:4.8, img:"nb-photo-2" },
  { id:"p2", name:"Barrel Cold Brew", cat:"Coffee", price:280, veg:true, best:true, seasonal:false, tags:["cold","smooth","strong"], desc:"Eighteen-hour steeped cold brew, oak-rested for a rounded, low-acid finish.", cal:20, allergens:[], prep:3, rating:4.9, img:"nb-photo-1" },
  { id:"p3", name:"Classic Cortado", cat:"Coffee", price:220, veg:true, best:false, tags:["hot","milk","balanced"], desc:"Equal parts espresso and steamed milk, no foam, quietly strong.", cal:90, allergens:["dairy"], prep:4, rating:4.6, img:"nb-photo-3" },
  { id:"p4", name:"Oat Flat White", cat:"Coffee", price:250, veg:true, best:true, tags:["hot","milk","creamy"], desc:"Double ristretto over microfoamed oat milk.", cal:140, allergens:["oat"], prep:4, rating:4.7, img:"nb-photo-4" },
  { id:"p5", name:"Iced Spanish Latte", cat:"Cold Drinks", price:290, veg:true, best:true, tags:["cold","sweet","milk"], desc:"Espresso, condensed milk, whole milk over ice.", cal:210, allergens:["dairy"], prep:4, rating:4.8, img:"nb-photo-5" },
  { id:"p6", name:"Hojicha Latte", cat:"Tea", price:270, veg:true, best:false, tags:["hot","cold","tea","toasty"], desc:"Roasted green tea, gently smoky, steamed with milk of choice.", cal:130, allergens:["dairy"], prep:5, rating:4.5, img:"nb-photo-6" },
  { id:"p7", name:"Jasmine Silver Tip", cat:"Tea", price:230, veg:true, best:false, tags:["hot","light","floral"], desc:"Hand-rolled green tea scented with fresh jasmine blossom.", cal:5, allergens:[], prep:6, rating:4.4, img:"nb-photo-2" },
  { id:"p8", name:"Sparkling Yuzu Tonic", cat:"Cold Drinks", price:260, veg:true, best:false, tags:["cold","citrus","refreshing"], desc:"Yuzu, elderflower and soda over ice.", cal:110, allergens:[], prep:3, rating:4.6, img:"nb-photo-1" },
  { id:"p9", name:"Almond Croissant", cat:"Bakery", price:180, veg:true, best:true, tags:["bakery","nutty"], desc:"Twice-baked croissant, almond cream, toasted flakes.", cal:420, allergens:["gluten","nuts","dairy"], prep:2, rating:4.9, img:"nb-photo-3" },
  { id:"p10", name:"Sourdough Toast, Whipped Ricotta", cat:"Breakfast", price:320, veg:true, best:false, tags:["breakfast","savory"], desc:"House sourdough, whipped ricotta, chili honey, thyme.", cal:380, allergens:["gluten","dairy"], prep:8, rating:4.7, img:"nb-photo-4" },
  { id:"p11", name:"Shakshuka", cat:"Breakfast", price:360, veg:true, best:true, tags:["breakfast","spiced"], desc:"Slow-braised tomato, peppers, baked eggs, feta, flatbread.", cal:460, allergens:["gluten","dairy","egg"], prep:14, rating:4.8, img:"nb-photo-5" },
  { id:"p12", name:"Roast Vegetable Grain Bowl", cat:"Lunch", price:390, veg:true, best:false, tags:["lunch","healthy"], desc:"Farro, roast squash, kale, tahini, pickled onion.", cal:520, allergens:["gluten","sesame"], prep:10, rating:4.5, img:"nb-photo-6" },
  { id:"p13", name:"Slow-Braised Chicken Focaccia", cat:"Lunch", price:420, veg:false, best:true, tags:["lunch","savory"], desc:"Rosemary focaccia, confit chicken, salsa verde.", cal:610, allergens:["gluten"], prep:9, rating:4.7, img:"nb-photo-2" },
  { id:"p14", name:"Miso Caramel Tart", cat:"Desserts", price:260, veg:true, best:true, tags:["dessert","sweet"], desc:"Dark chocolate shell, miso caramel, sea salt.", cal:390, allergens:["gluten","dairy","soy"], prep:2, rating:4.9, img:"nb-photo-1" },
  { id:"p15", name:"Basque Burnt Cheesecake", cat:"Desserts", price:240, veg:true, best:true, tags:["dessert","creamy"], desc:"Deeply caramelized, molten centre, no crust.", cal:410, allergens:["gluten","dairy","egg"], prep:2, rating:4.9, img:"nb-photo-3" },
  { id:"p16", name:"Brown Butter Brownie", cat:"Desserts", price:190, veg:true, best:false, tags:["dessert","chocolate"], desc:"Fudgy, brown butter, toasted walnut.", cal:380, allergens:["gluten","dairy","nuts"], prep:2, rating:4.6, img:"nb-photo-4" },
  { id:"p17", name:"Nitro Espresso Tonic", cat:"Signature", price:310, veg:true, best:true, tags:["cold","signature","bittersweet"], desc:"Nitrogen-charged espresso, house tonic, grapefruit oil.", cal:60, allergens:[], prep:5, rating:4.8, img:"nb-photo-6" },
  { id:"p18", name:"Cardamom Rose Cappuccino", cat:"Signature", price:290, veg:true, best:false, tags:["hot","signature","spiced"], desc:"House cardamom syrup, steamed milk, rose dust.", cal:160, allergens:["dairy"], prep:5, rating:4.7, img:"nb-photo-5" },
  { id:"p19", name:"Monsoon Chai Cold Foam", cat:"Seasonal", price:270, veg:true, best:false, seasonal:true, tags:["cold","seasonal","spiced"], desc:"Slow-brewed masala chai, iced, cardamom cold foam.", cal:180, allergens:["dairy"], prep:5, rating:4.8, img:"nb-photo-2" },
  { id:"p20", name:"Roasted Fig & Honey Cake", cat:"Seasonal", price:250, veg:true, best:false, seasonal:true, tags:["dessert","seasonal"], desc:"Brown butter cake, roasted fig, wild honey.", cal:360, allergens:["gluten","dairy","egg"], prep:2, rating:4.7, img:"nb-photo-1" },
  { id:"p21", name:"Turmeric Golden Latte", cat:"Signature", price:260, veg:true, best:false, tags:["hot","cold","spiced","light"], desc:"Turmeric, ginger, black pepper, steamed milk.", cal:120, allergens:["dairy"], prep:5, rating:4.4, img:"nb-photo-3" },
  { id:"p22", name:"Butter Croissant", cat:"Bakery", price:140, veg:true, best:true, tags:["bakery"], desc:"Laminated 36 hours, all butter, shatter crust.", cal:280, allergens:["gluten","dairy"], prep:1, rating:4.8, img:"nb-photo-4" },
  { id:"p23", name:"Iced Americano", cat:"Cold Drinks", price:180, veg:true, best:false, tags:["cold","strong","light"], desc:"Double espresso, cold water, over ice.", cal:5, allergens:[], prep:2, rating:4.5, img:"nb-photo-6" },
  { id:"p24", name:"Chamomile Honey Tisane", cat:"Tea", price:210, veg:true, best:false, tags:["hot","light","caffeine-free"], desc:"Whole chamomile flowers, wild honey on the side.", cal:20, allergens:[], prep:6, rating:4.3, img:"nb-photo-5" },
];
