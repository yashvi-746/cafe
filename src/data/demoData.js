...
export const PRODUCTS = [
  { id:"p1", name:"Ethiopian Pour Over", cat:"Coffee", price:260, veg:true, best:true, tags:["hot","light","fruity"], desc:"Single-origin Yirgacheffe, washed process, notes of jasmine and stone fruit.", cal:15, allergens:[], prep:5, rating:4.8, img:"https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=800&q=80" },
